...
T_gate = 5e-9;
Tau    = 10e-6;
eta    = 0.10; % eficiencia propia de la banda C; la que se pretende detectar
f      = 50e6;
...
d0   = readtable('stokes_conexion_internet_sin_distancia.csv');
d2   = readtable('stokes_conexion_internet_2km.csv');
d10  = readtable('stokes_conexion_internet_10km.csv');
d12  = readtable('stokes_conexion_internet_12km.csv');
...
title('Modelo Raman Stokes - Escenario de comunicaciones real','FontSize',16)
